    ...
    <div className="flex flex-col h-full">
      <main className="flex-1 flex flex-col gap-8 items-center sm:items-start p-4">
        <Image
          ...
          src="/app/images/daryo-logo.svg"  // Changed image source
          alt="daryo.pl logo" // Changed alt text
          width={180}
          height={38}
          priority
        />
      ...
      <div className="flex flex-col w-full max-w-[95%] h-[40%] m-4 p-2 border border-gray-300 rounded bg-orange-700 text-stone-700 text-2xl font-[family-name:var(--font-cascadia-code)] overflow-y-auto">
        <textarea
          ref={textareaRef}
